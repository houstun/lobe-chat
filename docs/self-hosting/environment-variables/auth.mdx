...
#### `AUTH_FEISHU_EMAIL_MAP`

- Type: Optional
- Description: Explicit `union_id=email` mappings used when the current Feishu scopes cannot return a real email. Separate multiple entries with commas or new lines.
- Default: `-`
- Example: `on_xxxxxxxxxxxxxxxx=user@example.com`
